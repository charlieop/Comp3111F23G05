...
class CalculateShortestPathTest {
    ...
    void SpecialTestCase() {
        ...
        //Boundary cases
        Coordinate[] noPath = GameManager.getInstance().CalculateShortestPath(map, new Coordinate(0, 12), new Coordinate(4, 1));
    ...
    void TypicalTestCase() {
        Coordinate[] randomPath1 = GameManager.getInstance().CalculateShortestPath(map, new Coordinate(7, 1), new Coordinate(6, 16));
        assertEquals(23, randomPath1.length);
        Coordinate[] randomPath2 = GameManager.getInstance().CalculateShortestPath(map, new Coordinate(8, 28), new Coordinate(20, 28));
        assertEquals(49, randomPath2.length);
        Coordinate[] randomPath3 = GameManager.getInstance().CalculateShortestPath(map, new Coordinate(4, 16), new Coordinate(26, 13));
        assertEquals(46, randomPath3.length);
        Coordinate[] EntryToExit = GameManager.getInstance().CalculateShortestPath(map, map.entryPos, map.exitPos);
